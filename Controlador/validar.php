      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
          <div class="card rounded-0 p-0 shadow-sm">
            <img src="dash promociones.jpg" class="card-img-top rounded-0">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
          <div class="card rounded-0 p-0 shadow-sm">
            <img src="dash ecommerce.jpg" class="card-img-top rounded-0">
            <div class="card-body text-center">
